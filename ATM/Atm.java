...
public class Atm {
    ...
    public static void main (String [] args)throws IOException {
		...
		for(i=0; i<=2; i++){
			...
			System.out.println("=================================================");
			System.out.println("          Selamat Datang Di ATM DILA INDONESIA          ");
                        System.out.println("=================================================");
			...
			if( (user.equalsIgnoreCase("nurpadilah")) && (password==340) ){
			...
			while(true){
				System.out.println("=================================================");
				System.out.println("                   ATM DILA INDONESIA                   ");
				System.out.println("=================================================");
				System.out.println("\n1.Cek Saldo");
				...
				switch (pilihan) {
					...
					do{
                                            ...
                                            System.out.println("8. Jika terdapat masalah pada mesin ATM hubungi 082-5437xxx");
                                            System.out.println("=================================================");
                                            System.out.println("\n1.keluar");
                                            System.out.println("2.Kembali");
                                            System.out.print("\nPilih Menu : ");
